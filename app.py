...
from routers.ai_draft_generator import router as ai_draft_router
...
app.include_router(ai_draft_router,prefix="/api/ai_draft/generator",tags=["AI_draft_generator"])
